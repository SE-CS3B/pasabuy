<template class="bg-gray-00 font-nunito">
  <div>
    <div class="desktopVersion">
      <div
        id="login"
        class="login items-center justify-center bg-gray-100 md:min-h-screen md:flex"
      >
        <div
          class="w-4/12 my-12 overflow-hidden font-bold text-center bg-white shadow-md flex-grow-1 md:w-4/12 rounded-xl"
        >
          <div class="px-10 py-16">
            ...
            <div class="mt-6 text-left text-md text-grey-dark">
              <a
                class="font-bold no-underline border-b border-blue text-blue"
                href="#"
              >
                Forgot Password?
              </a>
    ...
    <div class="mobileVersion">
      <div
        id="login"
        class="login items-center justify-center bg-gray-100 sm:max-h-screen sm:flex"
      >
        <div class="overflow-hidden font-bold text-center bg-white">
          <div class="px-10 py-16">
            <h1 class="space-x-1 space-y-1 text-2xl">Welcome back!</h1>
            <p class="mb-5 space-y-1 font-light text-gray-500">
              Log in with your email and password
